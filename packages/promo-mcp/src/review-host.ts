...
@media (max-width:940px) { .hero,.review-board { grid-template-columns:1fr; }.rail,.side { position:static; }.rail { display:flex; overflow:auto; gap:8px; }.rail::before { display:none; }.rail button { min-width:105px; }.step { padding-left:27px; }.workbench-head { align-items:start; flex-direction:column; } }.@media (max-width:550px) { .topbar { padding:0 16px; }.page { padding:38px 18px 80px; }.artifact-hint { display:none; }.hero { gap:25px; }.workbench { padding:18px; }.root-heading { align-items:start; flex-direction:column; gap:5px; }.root-heading code { max-width:100%; } }
`;
