...
test("creates an agent capsule for a budgeted creative outline", () => {
  ...
  assert.deepEqual(capsule.guidance.policies.map((policy) => policy.id), ["promo-workflow-orchestration", "promo-writing-supervision", "product-voiceover-campaign", "promo-deliverable-exemplars"]);
