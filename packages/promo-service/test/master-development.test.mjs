...
test("creates a master-development Agent-work capsule", () => {
  ...
  assert.deepEqual(brief.guidance.policies.map((policy) => policy.id), ["human-language-writing", "promo-writing-supervision", "promo-storyboard-supervision", "product-voiceover-campaign", "promo-deliverable-exemplars", "tim-cinematic-video-proof-plan"]);
