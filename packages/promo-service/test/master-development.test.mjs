...
test("creates a master-development Agent-work capsule", () => {
  ...
  assert.deepEqual(brief.guidance.policies.map((policy) => policy.id), ["promo-workflow-orchestration", "promo-writing-supervision", "promo-storyboard-supervision", "product-voiceover-campaign", "promo-deliverable-exemplars"]);
